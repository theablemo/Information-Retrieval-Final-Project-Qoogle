...
class QuranicExtraction(object):
    def __init__(self, model = 'excact', precompiled_patterns = 'prebuilt', num_of_output_in_apprx_model = 20):
        ...
        #         with open("parsi_io/modules/quranic_extractions/pickles/quran_df.pickle", 'rb') as f:
        #             self.quran_df = pickle.load(f)
        #
        #         "Load previously normalized qbigram_bag"
        #         with open("parsi_io/modules/quranic_extractions/pickles/qbigram_bag.pickle", 'rb') as f:
        #             self.qbigram_bag = pickle.load(f)
        #
        #         "Load previously compiled qbigram patterns"
        #         with open("parsi_io/modules/quranic_extractions/pickles/qbigram_compiled.pickle", 'rb') as f:
        ...
        #         if not os.path.exists('parsi_io/modules/quranic_extractions/pickles/verses_rules_compiled.pickle'):
        #             with zipfile.ZipFile('parsi_io/modules/quranic_extractions/pickles/verses_rules_compiled.zip', 'r') as zip_ref:
        #                 zip_ref.extractall('parsi_io/modules/quranic_extractions/pickles/')
        #         with open("parsi_io/modules/quranic_extractions/pickles/verses_rules_compiled.pickle", 'rb') as f:
        #             self.verses_rules_compiled = pickle.load(f)
        #
        #         self.use_precompiled_patterns = True
        # elif self.model_type == 'apprx':
        #     "Load and normalize quran"
        #     self.quran_df = pd.read_csv('parsi_io/modules/quranic_extractions/data/Quran.txt', sep="##|\t", names=['sore', 'aye', 'text'], engine='python')
    ...
    #
    #     "Read quranic data"
    #     quran_df_index = pd.read_csv('parsi_io/modules/quranic_extractions/data/Quran.txt', names=['id', 'text'], sep="\t")['id']
    #     self.quran_df = pd.read_csv('parsi_io/modules/quranic_extractions/data/Quran.txt', sep="##|\t", names=['surah', 'verse', 'text'],
    #                            engine='python')
    ...
    #         with open("parsi_io/modules/quranic_extractions/pickles/quran_df.pickle", 'wb') as f:
    #             pickle.dump(self.quran_df, f)
    #
    #     self.qbigram_bag = self.create_regexitize_bigram_bag(self.quran_df)
    #     if save_compiled_patterns:
    #         with open("parsi_io/modules/quranic_extractions/pickles/qbigram_bag.pickle", 'wb') as f:
    ...
    #     if save_compiled_patterns:
    #         with open("parsi_io/modules/quranic_extractions/pickles/qbigram_compiled.pickle", 'wb') as f:
    ...
    #     if save_compiled_patterns:
    #         with open('parsi_io/modules/quranic_extractions/pickles/verses_rules_compiled.pickle', 'wb') as f:
