...
from information_retrieval.lib.quran_mir.fasttext_vectorizer import sent_to_vec, merged_corpus_embeddings
...
class FastTextEngine(BaseEngine):
    ...
    def process_query(text):
        ...
        results = list(get_most_similars(quran_series, merged_corpus_embeddings, query_vec, 10).to_dict('records'))
        return [
            {
                "verse": result,
                "verse_number": 1,
